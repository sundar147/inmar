    ...
    <div class="container">
        <div class="row tm-register-row tm-mb-35">
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 tm-login-l">
                <form action="ret_login_check.php" method="post" class="tm-bg-black p-5 h-100">
                    ...
                    <div class="tm-flex-lr">
                        ...
                        <input type="submit" value="LOGIN" class="waves-effect btn-large btn-large-white px-4 black-text rounded-0">
                    </div>
                </form>
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 tm-login-r">
                <header class="font-weight-light tm-bg-black p-5 h-100">
                    ...
                    <p class="mb-0">Unless a tree has borne blossoms in spring, you will vainly look for fruit on it in autumn.</p>
                </header>
            </div>
        </div>
